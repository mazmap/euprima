...
summary2 = testing_utils.benchmark(euprima.ecp_2d3c_hw_optimized, input_generator2, ig_args)
...
df.to_csv(f"benchmark_ecp_2d3c_T{T}.csv", index=False)

plt.figure(figsize=(10, 6))
plt.plot(ig_args, [t*1000 for t in summary1], label='ecp_2d3c [euprima]', marker='o', markersize=2)
plt.plot(ig_args, [t*1000 for t in summary2], label='ecp_2d3c_hw [euchar]', marker='o', markersize=2)
