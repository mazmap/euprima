...
print("ECP_2d3c (induced top-cell)")
testing_utils.check_pairwise_equality([ecp3_naive, ecp3, ecp3_o, ecp3_hw, ecp3_hw_test, ecp3_hl_mc], labels=["ecp3_naive", "ecp3","ecp3_o","ecp3_hw", "ecp3_hw_test", "ecp3_hl_mc", "ecp3_hl"])
