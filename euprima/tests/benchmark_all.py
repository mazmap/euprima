...
summary6 = testing_utils.benchmark(ecp_hale_t_eulearning_2d3c, input_generator, ig_args)
...
summary7 = testing_utils.benchmark(ecp_hale_v_eulearning_2d3c, input_generator, ig_args)
append_column_to_csv("HALE:V(2,3) like eulearning [euprima]", summary7, ig_args)
...
summary8 = testing_utils.benchmark(euprima.ecp_belt_2d3c, input_generator2, ig_args)
append_column_to_csv("BELT(2,3) [euprima]", summary8, ig_args)
